...
worker()
  .using<DiscordEnvContext>(new DiscordGuildModule({guildId: "888801480709128282", tokenKey: "discordTestBotToken"}))
  .using<OpenAIEnvContext>(new OpenAIModule({tokenKey: "openAIApiToken", textModels: {high: "text-davinci-003", medium: "text-curie-001", low: "text-babbage-001"}}))
